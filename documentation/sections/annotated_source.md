...
你能夠從[這裡](annotated-source/)以符合人體工學的方式一覽 CoffeeScript <%= fullVersion %> 的原始碼。你也能從這裡直接查看指定的原始碼檔案：

- [文法規則 — src/grammar](annotated-source/grammar.html)
- [詞語解析 — src/lexer](annotated-source/lexer.html)
- [覆寫器 — src/rewriter](annotated-source/rewriter.html)
...
- [回饋式 REPL — src/repl](annotated-source/repl.html)
- [原始碼映照 — src/sourcemap](annotated-source/sourcemap.html)
